...
STAGE_INFOS = {
    1: ('Stage 1', (canvas_width // 2, 562, 500, 100)), # 562 = canvas_height // 2 + 130, 
    2: ('Stage 2', (canvas_width // 2, 432, 500, 100)), # 432 = canvas_height // 2, 
    3: ('Stage 3', (canvas_width // 2, 302, 500, 100)), # 302 = canvas_height // 2 - 130
}
